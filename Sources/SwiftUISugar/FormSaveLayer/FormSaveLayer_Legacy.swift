...
public struct FormSaveLayer_Legacy: View {
...
struct FormSaveLayerLegacyPreview: View {
...
struct FormSaveLayerLegacy_Previews: PreviewProvider {
    static var previews: some View {
        FormSaveLayerLegacyPreview()
    }
}
