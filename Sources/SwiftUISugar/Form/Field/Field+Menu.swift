...
extension Field {
    ...
    @ViewBuilder
    static func menu<LabelContent: View>(for options: [SelectionOption], label: LabelContent, value: Binding<String>?, contentProvider: FieldContentProvider?, onOptionSelection: @escaping ((SelectionOption) -> Void)) -> some View {
        Menu {
